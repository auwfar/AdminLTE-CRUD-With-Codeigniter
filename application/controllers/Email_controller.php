...
class Email_controller extends CI_Controller {
    ...
    public function send_mail(){
        ...
        // $this->email->libraries('email',$config);
        $this->email->from('nyimasantam@gmail.com', 'Sampah Pintar');
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="logo" style="text-align: center;">
                          ...
                          <h2>'.$nama.'</h2> 
                          <P><h3>Anda melakukan Reset Password<br>
                          Klik link di bawah untuk merubah Password akun anda:</h3></P>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="padding: 1 1.5em; text-align: center; padding-bottom: 0em;">
                         <a href="https://#/changepswd?key='.$tokenn.'" class="btn btn-primary">Ubah Sandi</a>
                        </td>                  
                      </tr>
                      <tr>
              ...
              <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                <tr>
                  <td valign="middle" class="bg_light footer email-section">
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              <td style="text-align: left; padding-right: 10px;">
                                ...
                                <p>Bank Sampah Pok Lisa Jaka 1.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                ...
                                <ul>
                                  <li><span class="text">Jln TB Badaruddin RT 01 RW 05 Kel Jatinegara Kaum Pulogadung</span></li>
                    ...
                    <img src="https://nyimasantam.my.id/image/LogoLMANTAM.png" width="350">
                  </td>
                </tr>
                <tr>
